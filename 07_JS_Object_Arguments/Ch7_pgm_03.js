...
getCarInfo = function (car) {
    return car.year + " " + car.make + " " + car.model.toUpperCase() + ": " + car.type + " (" + car.color + ")";
};

car1 = buildCar("Toyota", "Camry", 2020, "Sedan", "Blue");
car2 = buildCar("Tesla", "Model S", 2022, "Electric", "Red");
